...
$(document).ready(function () {
    ...
    $("#btnUploadSal").click(function (e) {
        ...
        e.preventDefault();
        if (window.FormData !== undefined) {
            var fileUpload = $('#upldfilesal').get(0);
            var files = fileUpload.files;
            if (files.length <= 0) {
                alert("Please select the file you are to upload!");
                return;
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.RespCode === 0) {
                        ...
                        salarytable = $('#example1_salup').tableToJSON();
                        console.log('**salary', salarytable)
                    }
                    else {
        ...
        if (curStepBtn === 'step-2') {
            swal({
                ...
                if (isConfirm) {
                    ...
                    //var Witholding = $('#example1_wht').tableToJSON();  Commented these out because we decoupled Witholding Tax from Payee
